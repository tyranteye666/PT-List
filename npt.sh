...
echo $'[ dns ]';
echo $' -DNS Query ID Field Prediction Cache Poisoning: nmap -sU -p 53 --script=dns-random-srcport '$ip;
...
echo $' -DNS Server Recursive Query Cache Poisoning Weakness: nmap -Pn -sU -p 53 --script=dns-recursion '$ip;
